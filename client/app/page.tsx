    ...
    <div className="animate-fade-in">
      ...
      <div className="max-w-[1400px] mx-auto px-10">
        ...
        <div className="grid grid-cols-12 gap-x-6 border-b border-neutral-200">
          ...
          <div className="col-span-5 py-16 pl-8">
            <p className="text-micro font-bold uppercase tracking-widest text-neutral-400 mb-10">
              Research Intelligence
            </p>

            <div className="space-y-8">
              <MetricLarge value="87" label="Overall Confidence" color="green" />
              <MetricLarge value="92" label="Genre Match" color="green" />
              <MetricLarge value="74" label="Market Viability" color="yellow" />
              <MetricLarge value="28" label="Saturation Risk" color="red" />
            </div>
          </div>
        </div>
