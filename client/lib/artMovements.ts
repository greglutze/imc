...
export interface ArtMovement {
  ...
  name: string;
  era: string;
  category: string;               // e.g. "Graphic Design", "Fine Art", "Digital / Subculture"
  description: string;
  keywords: string[];              // visual vocabulary tags
  typeFamilies: {                  // recommended type when this movement leads
    display: string;
    body: string;
    direction: string;
  };
  colorDirection: string;          // one-liner for palette guidance
  promptFragment: string;          // inject into Midjourney / DALL-E prompts
  /** Genres that naturally align with this movement */
  genreAffinities: string[];
  /** Mood words that signal this movement */
...
export const ART_MOVEMENTS: ArtMovement[] = [
  {
    ...
    promptFragment: 'Swiss international style, grid-based composition, objective photography, Helvetica, clean modernist layout',
  ...
  },
  {
    ...
    promptFragment: 'Bauhaus design, geometric shapes, primary colors, functional composition, Herbert Bayer typography',
  ...
  },
  {
    ...
    promptFragment: 'Art Nouveau style, flowing organic lines, floral ornament, Mucha-inspired, decorative borders',
  ...
  },
  {
    ...
    era: '1917–1931',
    category: 'Fine Art / Design',
    description: 'Pure abstraction: primary colors only, horizontal and vertical lines, white/black/gray. Mondrian\'s grids as spiritual geometry.',
    keywords: ['primary colors', 'grid', 'abstraction', 'Mondrian', 'minimalism'],
    typeFamilies: {
      display: 'Architype Mondrian / Futura',
    ...
    promptFragment: 'De Stijl style, Mondrian-inspired grid, primary colors, geometric abstraction, horizontal and vertical lines only',
  ...
  },
  {
    ...
    era: '1960s–70s',
    category: 'Graphic Design',
    description: 'Distorted, melting letterforms. Saturated complementary colors, op-art patterns, spiritual symbols. Wes Wilson and Victor Moscoso.',
  ...
  },
  {
    ...
    era: '1955–1969',
    category: 'Fine Art',
    description: 'Consumer culture as canvas. Bold outlines, Ben-Day dots, flat color, irony. Warhol\'s screen prints, Lichtenstein\'s comics.',
    ...
    promptFragment: 'Pop Art style, bold outlines, Ben-Day dots, flat saturated color, Warhol screen print aesthetic, comic-book inspired',
  ...
  },
  {
    ...
    era: '1950s–80s',
    category: 'Graphic Design',
    description: 'Reduction to essentials. Clean grids, restrained palettes, rational layout. Paul Rand\'s corporate identity work epitomizes it.',
    keywords: ['rational', 'grid', 'Paul Rand', 'corporate identity', 'clean'],
    typeFamilies: {
    ...
    promptFragment: 'Modernist graphic design, clean grid layout, restrained color, Paul Rand inspired corporate identity, rational composition',
  ...
  },
  {
    ...
    era: '1970s–90s',
    category: 'Graphic Design',
    description: 'Rules as fodder. Layered typography, historical pastiche, irony, clashing fonts and colors. April Greiman, Wolfgang Weingart.',
    keywords: ['pastiche', 'layered', 'irony', 'rule-breaking', 'Cranbrook'],
    typeFamilies: {
      display: 'Emigre fonts / Template Gothic / Dead History',
    ...
    promptFragment: 'Postmodern graphic design, layered typography, historical pastiche, clashing fonts, ironic composition, Cranbrook style',
  ...
  },
  {
    ...
    description: 'Fragmentation and dislocation. Type escapes the grid, visuals pulled apart. David Carson\'s Ray Gun magazine is the touchstone.',
    keywords: ['fragmented', 'anti-grid', 'David Carson', 'grunge type', 'chaos'],
    typeFamilies: {
      display: 'Arbitrary / Keedy Sans / Dead History',
    ...
    promptFragment: 'Deconstructivist design, fragmented layout, David Carson Ray Gun style, grunge typography, anti-grid composition',
  ...
  },
  {
    ...
    promptFragment: 'Memphis design style, pastel and neon palette, squiggles and terrazzo patterns, Sottsass inspired, geometric kitsch',
  ...
  },
  {
    ...
    typeFamilies: {
      display: 'Datacrux / VCR OSD Mono / Chrome-effect type',
      body: 'MS Gothic / Arial',
      direction: 'Retro digital fonts, Japanese characters mixed with Latin. Chrome and gradient text effects. VHS tracking lines.',
    },
  ...
  },
  {
    ...
    era: '1920s–50s',
    category: 'Fine Art',
    description: 'Dreamscapes. Unexpected juxtapositions, hyper-realistic rendering of impossible scenes. Dalí\'s melting clocks, Magritte\'s bowler hats.',
    ...
    promptFragment: 'Surrealist art, dreamscape, unexpected juxtapositions, hyper-realistic impossible scenes, Dalí and Magritte inspired',
  ...
  },
  {
    ...
    era: '1905s / 1970s–80s',
    category: 'Fine Art',
    description: 'Emotion over depiction. Distorted figures, violent brushwork, raw color. Munch, Kirchner, then Basquiat and Schnabel.',
    keywords: ['raw emotion', 'distortion', 'painterly', 'Basquiat', 'visceral'],
    typeFamilies: {
      display: 'Hand-painted / Basquiat crown motif / Knockout',
    ...
    promptFragment: 'Expressionist art, raw emotional brushwork, distorted figures, Basquiat-inspired, violent color, visceral mark-making',
  ...
  },
  {
    ...
    era: '1960s–present',
    category: 'Fine Art / Design',
    description: 'Nothing extra. Monochrome or near-monochrome, geometric form, negative space as protagonist. Frank Stella, Donald Judd.',
    ...
    promptFragment: 'Minimalist art, monochrome, geometric form, negative space, reduction to essentials, Frank Stella Donald Judd inspired',
  ...
  },
  {
    ...
    typeFamilies: {
      display: 'Grilli Type (GT) / Whyte / Pangram fonts',
  ...
  },
  {
    ...
    typeFamilies: {
      display: 'Blade Runner font / Orbitron / Rajdhani',
    ...
    promptFragment: 'Cyberpunk aesthetic, neon lights on dark cityscape, rain-slick streets, holographic displays, chrome and decay, Blade Runner',
  ...
  },
  {
    ...
    era: '2010s',
    category: 'Digital / UX',
    description: 'No skeuomorphism. Pure 2D, solid color, clean iconography. Reaction against iOS 6 glass effects. Microsoft Metro was first.',
    ...
    colorDirection: 'Solid, saturated blocks. Google material palette. Friendly, approachable colors.',
  ...
  },
  {
    ...
    keywords: ['grid + texture', 'photocopy', 'subversion', 'Weingart', 'punk'],
    typeFamilies: {
    ...
    promptFragment: 'Swiss Punk typography, Weingart-inspired, grid subverted by photocopy texture, rubber stamps over Helvetica, punk energy',
  ...
  },
  {
    ...
    description: 'Optimism rendered in organic shapes. Atomic motifs, Eames curves, earthy + turquoise palettes, playful illustration, teak everything.',
    keywords: ['atomic', 'organic curves', 'earthy', 'Eames', 'optimism'],
    typeFamilies: {
    ...
    promptFragment: 'Mid-century modern design, atomic age motifs, Eames-inspired organic shapes, earthy turquoise palette, retro illustration',
  ...
  },
  {
    ...
    era: '1915–1925',
    category: 'Fine Art',
    description: 'Pure geometric abstraction: squares, circles, crosses. Black on white. Malevich\'s Black Square as year zero of abstract art.',
    keywords: ['geometric', 'black on white', 'pure abstraction', 'Malevich', 'reductive'],
    typeFamilies: {
    ...
    promptFragment: 'Suprematist art, Malevich-inspired, pure geometric abstraction, black square, floating forms on white, reductive',
  ...
  },
  {
    ...
    era: '2000s–present',
    category: 'Digital',
    description: 'Error as medium. RGB channel separation, pixelation, databending, scan-line breaks. Malfunction aestheticized, control relinquished.',
  ...
  },
  {
    ...
    era: '1970s–present',
    category: 'Design / Illustration',
    description: 'Softness as power. Pastel palettes, round forms, simplified faces, small features on large heads. Hello Kitty as cultural object.',
...
/**
 * Score all movements against a concept and return the top N matches.
 *
 * Scoring weights:
 *  - Genre affinity match:      +3 per matching genre word
 *  - Mood keyword match:        +2 per matching mood word
 *  - Creative direction match:  +1 per matching movement keyword found in direction text
 */
export function matchMovements(
  ...
  const scored: MatchedMovement[] = ART_MOVEMENTS.map(mov => {
    ...
    // 1. Genre affinity — check if any genre tokens appear in the movement's genre affinities
    for (const aff of mov.genreAffinities) {
      ...
      for (const tok of affTokens) {
        if (genreTokens.has(tok)) {
          ...
          break;                       // one hit per affinity string
        }
      }
    }

    // 2. Mood affinity — check concept mood keywords vs movement mood affinities
    for (const aff of mov.moodAffinities) {
      if (moodTokens.has(aff)) {
        score += 2;
        reasons.push(`mood: ${aff}`);
      }
      // Also partial: if the mood affinity appears inside any of the concept moods
    ...
    // 3. Creative direction text — check movement keywords in direction prose
    ...
    return { movement: mov, score, matchReasons: uniqueReasons };
  });
...
/** Tokenize a string into lowercase words, splitting on spaces, hyphens, slashes */
